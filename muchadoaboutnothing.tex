...
\include{./tex/background_chapter}
\include{./tex/objective_chapter}
\include{./tex/data_method_chapter}

\part{Rainfall Intensity and Erosion: Model Descriptions and Responses}
\label{sec:RAINFALLINTENSITYCHANGESANDSOILEROSION}
\include{./tex/improved_cligen_chapter}
\include{./tex/temporal_resolution_chapter}
\include{./tex/continue_discontinue_rainfall_chapter}
\include{./tex/intensity_pattern_chapter}
%\include{./tex/model_result_summary}
%\include{./tex/bp2bp_variation_chapter}

%\part{Observed Rainfall Characteristics (and Intensity) of The Study Site}
%\label{sec:OBSERVEDPRECIPITATIONOFTHERESEARCHSITE}
%\include{./tex/observed_rainfall_chapter}
%\include{./tex/building_intensity_scenarios}
...
\include{./tex/future_erosion_chapter}

\part{Conclusion}
\label{sec:PARTCONCLUSION}
\include{./tex/conclusion_chapter}
...
\include{./tex/appendixC}
\include{./tex/appendixD}
\end{singlespace}
\end{appendices}
